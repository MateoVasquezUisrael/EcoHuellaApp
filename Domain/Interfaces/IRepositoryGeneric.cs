...
namespace EcoHuellaApp.Domain.Interfaces
{
    ...
    {
        public Task<List<T>> ObtenerTodosAsync(); //hacerlo async en la implementación
        ...
        public Task GuardarRegistroAsync(T entity); //siempre se devuelve un int en sql, async
